...
contract Swapper is ISwapper, Governable {
     ...
     */
    ISwapperOracle public override oracle;
    ...
    event OracleUpdated(ISwapperOracle oldOracle, ISwapperOracle newOracle);

    /// @notice Emitted when the max slippage is updated
    event MaxSlippageUpdated(uint256 oldMaxSlippage, uint256 newMaxSlippage);

    constructor(ISwapperOracle oracle_, uint256 maxSlippage_) {

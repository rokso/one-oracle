...
import {UmbrellaPriceProvider, UmbrellaPriceProvider__factory, IERC20, IERC20__factory} from '../../typechain-types'
...
describe('UmbrellaPriceProvider @mainnet', function () {
  ...
  describe('quoteTokenToUsd', function () {
    ...
    it('should quote WBTC to USD', async function () {
      ...
      expect(_amountOut).closeTo(parseEther('436,133'), parseEther('1'))
    })
